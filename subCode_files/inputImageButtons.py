...
########################################
button = (200, 50), (200,300), "Camera"    ##(width, height), (startWidth, startHeight)
button1 = (200, 50), (600,300), "Files"    ##(width, height), (startWidth, startHeight)
...
class IIbuttons():
    cv2.putText(img, 'Choose input image method:', (150,120), Buttonfont, 1, ButtonTextColor, 2)
    ...
    def __init__(self):
        ...
        cv2.setMouseCallback('image', IIbuttons.mouse_click)
        cv2.waitKey(0)
